...
public class SetUpAddressFragment extends BaseFragment implements View.OnClickListener, OnMapReadyCallback, GoogleMap.OnMyLocationButtonClickListener, GoogleMap.OnMapLongClickListener, CustomMapFragment.OnTouchListener {
        ...
        try {
            ...
            autocompleteFragment.setOnPlaceSelectedListener(new PlaceSelectionListener() {
                ...
                public void onError(Status status) {
                    ...
                    Log.d("okhttp", "An error occurred: " + status);
                }
            });
